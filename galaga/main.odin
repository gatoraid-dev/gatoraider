...
spaceship := Ship{raylib.Rectangle{}, raylib.Vector2{260, 700}, raylib.LoadTexture("assets/ship.png"), 5, 3, 1.0, 0}
blast := raylib.LoadTexture("assets/blast.png")
blastB := raylib.LoadTexture("assets/blastB.png")
alien := raylib.LoadTexture("assets/alien.png")
...
aliens := [dynamic]Alien{
    Alien{raylib.Rectangle{}, raylib.Vector2{clamp(baseAlienPos.x, f32(0), f32(screenWidth - alien.width)), clamp(baseAlienPos.y, f32(0), f32(200))}, 0.1, true, false, 2},
    Alien{raylib.Rectangle{}, raylib.Vector2{clamp(baseAlienPos.x - 70, f32(0), f32(screenWidth - alien.width)), clamp(baseAlienPos.y, f32(0), f32(200))}, 0.1, true, false, 2},
    Alien{raylib.Rectangle{}, raylib.Vector2{clamp(baseAlienPos.x + 70, f32(0), f32(screenWidth - alien.width)), clamp(baseAlienPos.y, f32(0), f32(200))}, 0.1, true, false, 2},
    Alien{raylib.Rectangle{}, raylib.Vector2{clamp(baseAlienPos.x - 140, f32(0), f32(screenWidth - alien.width)), clamp(baseAlienPos.y, f32(0), f32(200))}, 0.1, true, false, 2},
    Alien{raylib.Rectangle{}, raylib.Vector2{clamp(baseAlienPos.x + 140, f32(0), f32(screenWidth - alien.width)), clamp(baseAlienPos.y, f32(0), f32(200))}, 0.1, true, false, 2},
    Alien{raylib.Rectangle{}, raylib.Vector2{clamp(baseAlienPos.x - 210, f32(0), f32(screenWidth - alien.width)), clamp(baseAlienPos.y, f32(0), f32(200))}, 0.1, true, false, 2},
    Alien{raylib.Rectangle{}, raylib.Vector2{clamp(baseAlienPos.x + 210, f32(0), f32(screenWidth - alien.width)), clamp(baseAlienPos.y, f32(0), f32(200))}, 0.1, true, false, 2},
}
